...
var libraryTreeData = [
{
	...
	},
	{
		...
		children: [
			{ title: "最新（2007年～）", type: "map", key: "ort", icon: "photo.png", dataset: dataSet_ort, zindex: 250 },
			{ title: "1988～90年", type: "map", key: "gazo4", icon: "photo.png", dataset: dataSet_gazo4, zindex: 255 },
			{ title: "1984～87年", type: "map", key: "gazo3", icon: "photo.png", dataset: dataSet_gazo3, zindex: 260 },
			{ title: "1979～83年", type: "map", key: "gazo2", icon: "photo.png", dataset: dataSet_gazo2, zindex: 265 },
			{ title: "1974～78年", type: "map", key: "gazo1", icon: "photo.png", dataset: dataSet_gazo1, zindex: 270 }
...
},
{
	...
	children: [
	{
		...
		children: [
			{ title: "東日本大震災の震度分布(茨城県)", type: "kml", key: "shindo", icon: "5+.png", path: "./site/mapuse4/kml/shindo.kml" }
		]
	}]
}];
